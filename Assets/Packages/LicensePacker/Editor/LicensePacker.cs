...
public class LicensePacker : IPostprocessBuildWithReport
{
    ...
    public void OnPostprocessBuild(BuildReport buildReport)
    {
        ...
        TextFileReadWriter.WriteToFile(outputDirectoryPath + "\\" + LicenseFileName, packedLicenseText);
    }
                                      ...
                                      params string[] ignoreDirectoriesStartsWith)
    {
        ...
        {
            TextFileIOResult readResult = TextFileReadWriter.ReadFromFile(licenseFile);
